...
pie_chart <- plot_ly(
  ...
  type = "pie",
  hoverinfo = "text",
  marker = list(colors = c("lightgreen", "yellow")) 
) %>%
layout(
  title = list(
...
<p style="text-align: left;">As depicted in the following figure, which represents the percentage of trips undertaken by customers and subscribers for each day of the week, a clear pattern emerges. Subscribers tend to take frequent trips throughout the day, every single day of the week, a behavior that is noticeably different from their non-member counterparts.</p>
...
* 1st route: 1.	Lake Shore Dr & Monroe St to Streeter Dr & Grand Ave, with a total of 2872 trips.
...
<p style="text-align: left;">The subsequent graph provides a distribution of these trips among customers and subscribers. Interestingly, these routes are predominantly used by customer riders, with over 94 percent of customers using the first route. 
...
<!-- ```{r Trip count by age, fig.width=5, fig.height=4} -->
...
<!-- ggplotly(age_range, tooltip = c("text")) -->


<!-- ``` -->
<!-- <figcaption style="text-align: left; font-style: italic;">Caption: Description of the graph goes here.</figcaption> -->
<!-- </figure> -->
...
<!-- ```{r trip count by Gender, echo=FALSE, fig.width=5, fig.height=4} -->
<!-- # 2019 dataset -->
...
<!--   labs(x = "Gender", y = "Percentage", title = "Percentage of Trips by Gender") + -->
<!--   theme_classic()+ -->
<!--   scale_fill_viridis_d()+ -->
<!--   easy_y_axis_title_size(size = 12)+ -->
<!--   easy_x_axis_title_size(size = 12)+ -->
...
<!--  ggplotly(trip_count_by_gender, tooltip = c("text")) -->



<!-- ``` -->
<!-- <figcaption style="text-align: left; font-style: italic;">Caption: Description of the graph goes here. <br>Our finance analysts have concluded that annual </figcaption> -->
<!-- </figure> -->
...
<p style="text-align: left;">My last insight from Cyclistic’s data is that most customer riders prefer electric bikes while subscribers use prefer classic ones as shown in figure 5. This insight suggest that Cyclistic should increase the number of bikes a the station that are frequently visited by customer riders. </p> <br>
...
<p style="text-align: left;">To see all Cyclistic bike stations on the map visit my [Tableau Public account ](https://github.com/kwizeras/Google_data_analytics_capstone-)</p>
